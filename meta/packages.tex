...
% general packages
\usepackage[a4paper, twoside, bindingoffset=1cm, 
			top=2.5cm, bottom=2cm, inner=2cm, outer=2cm]{geometry}	% set page margins
...
\usepackage{array}
\usepackage{ragged2e} % bessere Flattersatz-Umbrüche
