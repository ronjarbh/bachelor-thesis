...
Die Ergebnisse zeigen, dass \Gls{ux}-Methoden wie \Gls{personas}, \Gls{userjourneys} und \Gls{designpatterns} insbesondere dann wirksam sind, wenn sie systematisch, iterativ und organisationsübergreifend implementiert werden. Akzeptanz organisationaler Plattformen ergibt sich demnach aus dem Zusammenspiel von nutzerzentrierter Struktur, konsistenter Gestaltung und begleitender \Gls{changecommunication}. Die Arbeit leitet daraus praxisorientierte Empfehlungen für die Gestaltung und Weiterentwicklung interner Plattformen ab.
\vfil
...
Internal knowledge and collaboration platforms are increasingly fundamental to digital organizational environments, yet their effectiveness depends on usability, clarity, and user acceptance. This thesis examines how user experience (\acrshort{ux}) strategies influence the structure and effectiveness of information architecture in organizational platforms and identifies factors that support sustainable system adoption.
