...
Interne Wissens- und Kollaborationsplattformen spielen eine zentrale Rolle in digitalen Organisationsstrukturen, werden jedoch häufig nur eingeschränkt genutzt, wenn Informationsarchitektur und \Gls{ux} nicht an den Bedürfnissen der Nutzer ausgerichtet sind. Diese Arbeit untersucht, wie \Gls{ux}-Strategien zur Optimierung der Informationsarchitektur beitragen und welche Faktoren die Akzeptanz solcher Systeme beeinflussen.

Die theoretische Grundlage umfasst Konzepte der Informationsarchitektur, \Gls{ux}-Methodik, Kognitionspsychologie und organisationalen Veränderungsprozesse. Empirisch basiert die Arbeit auf einer qualitativen Einzelfallstudie mit leitfadengestützten Experteninterviews, ausgewertet mittels qualitativer Inhaltsanalyse.
