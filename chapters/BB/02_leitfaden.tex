...
Rückschlüsse auf einzelne Personen sind nicht vorgesehen.
...
\begin{enumerate}
  \item Alter (Kategorie)
  \item Geschlecht
  \item Organisationszugehörigkeit (innerhalb oder außerhalb der PO)
  \item Rolle/Funktion (Mehrfachnennung möglich)
  \item Persona-Zuordnung (gemäß Kapitel~3)
  \item Nutzungshäufigkeit des bisherigen Wikis
  \item Selbsteingeschätzte digitale Kompetenz (Likert-Skala)
\end{enumerate}
...
Erfasst werden folgende Messgrößen:

\begin{itemize}
  \item Bearbeitungszeit
  \item Anzahl der Fehler
  \item Anzahl der Klicks
  \item Subjektive Schwierigkeitseinschätzung
\end{itemize}
...
\label{tab:AA-testaufgaben}
\begin{tabularx}{\textwidth}{c X X X}
\toprule
Nr. & Szenario & Aufgabe & Erfolgskriterium \\
\midrule
1 &
Neue Mitarbeitende möchten verstehen, wofür die New Product Organization (NPO) steht. &
Finden Sie Informationen zum Auftrag und zur grundlegenden Struktur der NPO. &
...
4 &
Verständnis der Flow Structure in der NPO. &
...
\subsubsection{Block A -- Wahrgenommene Nützlichkeit und Gebrauchstauglichkeit (RQ-1)}
...
\item \textbf{HF-2 -- Mentale Modelle und Informationsarchitektur}\\
Gab es Situationen, in denen die Struktur Ihren Erwartungen entsprochen oder nicht entsprochen hat?
\end{enumerate}

%-------------------------------------------------------------

\subsubsection{Block B -- Personas, Rollenpassung und UX-Methoden (RQ-2)}
...
Wo wurde Ihre Rolle oder Persona besonders berücksichtigt?
Wo fehlte diese Passung?

\item \textbf{OF-1 -- Wahrgenommene UX-Methoden}\\
Welche Bereiche wirken speziell für Nutzergruppen entworfen, welche eher generisch?
\end{enumerate}

%-------------------------------------------------------------

\subsubsection{Block C -- Akzeptanz, Nutzungsintention und Kommunikation (RQ-3)}
...
\subsubsection{Block D -- Offenes Feedback}
