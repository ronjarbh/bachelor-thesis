...
Dieses Kapitel dokumentiert die aggregierte Auswertung der Usability-Tests und stellt die rechnerische Herleitung der in Kapitel~5 berichteten Kennzahlen dar. Ziel ist die transparente Nachvollziehbarkeit der quantitativen Befunde auf Basis der Rohdaten.

% -----------------------------------------------------
\subsection{Methodisches Vorgehen}

Alle Teilnehmenden bearbeiteten fuenf Aufgaben im alten sowie im neuen Wiki (n = 10, insgesamt 100 Messungen). Erfasst wurden:
\begin{itemize}
...
Fuer jede Aufgabe wurden arithmetische Mittelwerte, Mediane, Minimal- und Maximalwerte sowie Standardabweichungen berechnet. Zusaetzlich wurden Gesamtfehler, durchschnittliche Fehler pro Person sowie relative Verbesserungen zwischen alter und neuer Version bestimmt. Die Auswertung ist deskriptiv angelegt und dient der strukturierten Gegenueberstellung der Nutzungseffizienz und -effektivitaet.
...
Die Auswertung zeigt ueber alle Aufgaben hinweg deutliche Verbesserungen der Nutzungseffizienz und -effektivitaet im neuen Wiki. Besonders ausgepraegt sind die Effekte bei Aufgaben mit hohem Such- und Orientierungsaufwand (Aufgaben~2 und~3). Aufgabe~5 weist dagegen nur geringe Verbesserungen auf und stellt einen stabilen Ausreisser dar. Dieses Muster korrespondiert mit den qualitativen Aussagen zur eingeschraenkten Verstaendlichkeit der Personen- und Ansprechpartnerlogik.
